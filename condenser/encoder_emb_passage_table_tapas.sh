...
model_path="/data1/fch123/UDT-QA//condenser/model_MoE_tapas/" #"model_bert_prompt_raw" #model_bert_position_prompt_raw" #"text_raw_table_bert" #"/data1/fch123//UDT-QA/condenser/model_bert_text_table_raw/" #"facebook/dpr-ctx_encoder-single-nq-base" #$CONDENSER_MODEL_NAME #"/data2/private/fanchenghao/UDT-QA/condenser/model_nq3/"
...
do
echo $s
CUDA_VISIBLE_DEVICES=$1 python -m tevatron.driver.encode_MoE_tapas \
  --output_dir=$OUTDIR \
