...
output_path="/data2/private/fanchenghao/UDT-QA/condenser/model_bert_bias_2/"
cache_path="/data3/private/fanchenghao/.cache"
CUDA_VISIBLE_DEVICES=2,3,4,5 python -m torch.distributed.launch --nproc_per_node=4 -m tevatron.driver.MoE_bitfit \
