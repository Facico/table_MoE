...
output_path="/data1/fch123/UDT-QA/condenser/model_MoE_bias_2/"
cache_path="/data/fanchenghao/.cache"
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 -m tevatron.driver.MoE_train \
