output_dir="/data1/fch123/UDT-QA/condenser/nq-train-raw-table-tapex"
...
python prepare_wiki_train_MoE_tapex.py --input $table_bm25 --output $output_table_bm25 --negative_name negative_ctxs --add_type 1

python prepare_wiki_train_MoE_tapex.py --input $table_dpr --output $output_table_dpr --negative_name negative_ctxs --add_type 1

python prepare_wiki_train_MoE_tapex.py --input $nq_train_path --output $output_path

python prepare_wiki_train_MoE_tapex.py --input $hn_path --output $output_hn_path
