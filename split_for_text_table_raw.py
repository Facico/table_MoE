...
if __name__ == '__main__':
    ...
    table_path = "/data1/private/fanchenghao/UDT-QA-data/downloads/data/all_raw_table_chunks_for_index.json"
    output_path = "/data1/private/fanchenghao/UDT-QA-data/downloads/data/text_table_docs/"
    data = []
