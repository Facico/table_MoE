# tokenization
wiki_dir="/data2/private/fanchenghao/DPR/downloads" # path for psgs_w100.tsv downloaded with DPR code
ans_dir="/data2/private/fanchenghao/UDT-QA/downloads/data/retriever/qas/nq" # path for DPR question&answer csv files
text_question_dir="/data2/private/fanchenghao/DPR/downloads/data/retriever" # path for DPR training data : nq.train
table_question_dir="/data2/private/fanchenghao/UDT-QA/downloads/data/retriever/nq_raw_tables" # path for DPR training data : nq-train_raw_table_pos_bm25_neg.json
data_type=0 #0 is nq, 1 is trivia, 2 is both
out_data_dir="../data/QA_NQ_data/" # change this for different data_type

tokenization_cmd="\
python ../data/DPR_data_MoE.py --wiki_dir $wiki_dir --text_question_dir $text_question_dir --table_question_dir $table_question_dir \
--data_type $data_type --answer_dir $ans_dir \
