...
from tevatron.modeling_position_MoE_tapas import DenseModel_MoE
...
def main():
    ...
    for k, v in model.state_dict().items():
        ...
        if 'position_embedding' in k:
            ...
            if position_only.endswith('_text'):
                position_only = position_only[:-5] + '.weight'
            elif position_only.endswith('_table'):
                position_only = position_only[:-6] + '.weight'
            else:
