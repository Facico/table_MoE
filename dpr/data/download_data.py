...
RESOURCES_MAP = {
    ...
    "data.retriever.table_list": {
        "s3_url": "/data2/private/fanchenghao/DPR/downloads/data/retriever/table_list.tsv",
        "original_ext": ".tsv",
        "compressed": False,
        "desc": "Entire table",
    },
    "data.retriever.table_simple_list": {
        "s3_url": "/data2/private/fanchenghao/DPR/downloads/data/retriever/table_simple_list.tsv",
        "original_ext": ".tsv",
        "compressed": False,
        "desc": "Entire table",
    },
    "data.retriever.table_mine_list": {
        "s3_url": "/data2/private/fanchenghao/DPR/downloads/data/retriever/table_mine_list.tsv",
        "original_ext": ".tsv",
        "compressed": False,
        "desc": "Entire table",
    },
    ...
    "data.retriever.table_train":{
        "s3_url": [
            "table_train_{}.json".format(i)
            for i in range(49)
        ],
        "original_ext": ".json",
        "compressed": True,
        "desc": "NQ train table 0-48 subset",
        "license_files": NQ_LICENSE_FILES,
    },
    "data.retriever.table_dev":{
        "s3_url": "table_train_49.json",
        "original_ext": ".json",
        "compressed": True,
        "desc": "NQ train table 49 subset",
        "license_files": NQ_LICENSE_FILES,
    },
    "data.retriever.tapas_dpr_train":{
        "s3_url": "tapas_dpr_train.json",
        "original_ext": ".json",
        "compressed": False,
        "desc": "NQ tapas train tablet",
        "license_files": NQ_LICENSE_FILES,
    },
    "data.retriever.tapas_dpr_dev":{
        "s3_url": "tapas_dpr_dev.json",
        "original_ext": ".json",
        "compressed": False,
    ...
    "data.retriever.tapas_dpr_simple_dev":{
        "s3_url": "tapas_dpr_simple_dev.json",
        "original_ext": ".json",
        "compressed": False,
        "desc": "NQ tapas dev table",
        "license_files": NQ_LICENSE_FILES,
    },
    "data.retriever.tapas_dpr_mine_train":{
        "s3_url": "tapas_dpr_mine_train.json",
        "original_ext": ".json",
        "compressed": False,
        "desc": "NQ tapas train tablet",
        "license_files": NQ_LICENSE_FILES,
    },
    "data.retriever.tapas_dpr_mine_dev":{
        "s3_url": "tapas_dpr_mine_dev.json",
        "original_ext": ".json",
        "compressed": False,
        "desc": "NQ tapas dev table",
        "license_files": NQ_LICENSE_FILES,
    ...
    "data.retriever.qas.tapas-test": {
        "s3_url": "tapas-test.csv",
        "original_ext": ".csv",
        "compressed": False,
        "desc": "tapas nq test",
        "license_files": NQ_LICENSE_FILES,
